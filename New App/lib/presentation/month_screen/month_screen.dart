import '../month_screen/widgets/chipviewone_item_widget.dart';
import '../month_screen/widgets/chipviewtwo_item_widget.dart';
...
class MonthScreen extends StatelessWidget {
  ...
  /// Section Widget
  Widget _buildCityNameColumn(BuildContext context) {
    return SizedBox(
        height: 140.v,
        width: double.maxFinite,
  ...
  Widget _buildChipViewOne(BuildContext context) {
    return Padding(
        ...
        child: Wrap(
            ...
            spacing: 25.h,
            children:
                List<Widget>.generate(3, (index) => ChipviewoneItemWidget())));
  }

  /// Section Widget
  Widget _buildChipViewTwo(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 45.h),
        child: Wrap(
            runSpacing: 25.v,
            spacing: 25.h,
            children:
                List<Widget>.generate(3, (index) => ChipviewtwoItemWidget())));
  }
