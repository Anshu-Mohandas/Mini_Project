...
class MaldivesScreen extends StatelessWidget {
  const MaldivesScreen({Key? key})
      : super(
          key: key,
        );
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildMaldivesDetailsStack(context),
  ...
  /// Section Widget
  Widget _buildMaldivesStack(BuildContext context) {
    return SizedBox(
      height: 301.v,
      width: double.maxFinite,
      child: Stack(
  ...
  /// Section Widget
  Widget _buildMaldivesDetailsStack(BuildContext context) {
    return SizedBox(
      height: 799.v,
      width: 402.h,
      child: Stack(
